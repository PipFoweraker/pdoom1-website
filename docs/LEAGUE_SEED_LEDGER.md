...
| **L6** | `weekly-2026-w35` | L6 | `board_weekly-2026-w35__L6.json` | 2026-08-24 | Pip | **BLESSED at [Gate 5] by Pip at 19:36 on 2026-08-24, in the website seat.** **[Gate 6] OPENED in the same breath: the board on `weekly-2026-w35` at ladder epoch `L6` is open and may take scores.** pdoom1 **v0.14.3** forked L5 -> L6 and rolled the seed in the same release. Verified FROM THE ARTIFACT, not from a comment or a memory: the published v0.14.3 `release_manifest.json` carries `"ladder_version": "6"`, `"league_seed": "weekly-2026-w35"` and `"commit_hash": "161240bef1454851555ed042c640b67a0cf67d56"`. **Gate 6 check 4 -- one run has travelled the whole way and arrived -- was already satisfied when the gate was opened, by a real player rather than a test run:** the board held one entry, lab `bubble gum factory -- mic oxe`, score 21, posted 2026-08-24 by the site's first external reviewer. That score existed on a board the site was not publishing for roughly five hours, which is the harm this ceremony exists to end rather than a reason to delay it. **The seed WAS rolled this time**, unlike the L4 -> L5 fork where it was held: v0.14.3 moved both halves of the key, so `(weekly-2026-w33, L5)` is closed with zero entries and is archived at `public/leaderboard/data/preserved/2026-08-24-l5-epoch-close/`. The release notes record the slip honestly -- the rolls to `w34` (23 Aug) and `w35` (24 Aug) were made in the repository and never reached a published build, so players stayed on `w33`/`L5` until this release carried them across. |
