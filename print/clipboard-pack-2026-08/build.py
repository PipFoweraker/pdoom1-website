...
at v0.14.1 or from pdoom1.com. The licence is SOURCE-AVAILABLE, not open
...
def dial_svg(w, r1_frac=0.36, labels=True, label_size=None, needle=None,
    ...
    r2 = w / 2.0
    r1 = r2 * r1_frac
    pad = max(3.0, r2 * 0.14)   # headroom so rim labels never clip
    h = r2 + 6
    cx, cy = r2, r2 + 1
...
MONOFACTS = [
    "alpha &middot; v0.14.1 &middot; built in Godot 4.5.1",
    "source-available (not open source) &mdash; see LICENSE",
    "Windows / macOS / Linux &middot; free download",
...
<div style="position:absolute; bottom:14mm; left:0; right:0">
  ...
  build v0.14.1 unless it is printed as a question. The licence is source-available; the
...
<div style="display:flex; gap:4mm">
  <div class="box" style="flex:1">
    ...
    <b>Alpha</b>, v0.14.1, built in Godot 4.5.1. Windows build tested; macOS and Linux
    builds are published but less tested. Builds are not yet code-signed, so your OS will
    warn you the developer is unidentified &mdash; that is expected, and the website walks
    you past it.</div>
  </div>
  <div class="box" style="flex:1">
...
<div style="width:85mm;height:55mm;position:relative;background:#fff;overflow:hidden;
  ...
  <div style="position:absolute;top:0;left:0;right:0;height:10mm;background:#000;
       color:#fff;font-size:9pt;padding:2.5mm 4mm">p(doom)1 &mdash; v0.14.1-alpha</div>
...
ZPAGES = {
 ...
 7: ztitle("6 &middot; the status") + f'<div style="{zbody}">Alpha, v0.14.1, built in '
    'Godot 4.5.1. Windows / macOS / Linux, free download. Source-available &mdash; not '
...
<div style="position:absolute; top:0; bottom:0; left:{ZW}mm" class="foldline" style2=""></div>
...
not a promise. Current truth: free source-available alpha, downloadable now, Windows build
tested, macOS/Linux published with less testing.</div>""",
    folio="19/30"))
...
<div style="width:132mm; height:190mm; position:relative; background:#fff; overflow:hidden">
  ...
  <div style="position:absolute; bottom:12mm; left:10mm; width:88mm" class="mono small">
    pdoom1.com &middot; free source-available alpha<br>Windows / macOS / Linux</div>
...
<div style="position:relative; width:190mm; height:88mm; border:0.4mm solid #000">
  ...
  <div style="position:absolute; bottom:6mm; left:7mm" class="mono small">
    ...
    free download &middot; Windows / macOS / Linux &middot; source-available alpha v0.14</div>
